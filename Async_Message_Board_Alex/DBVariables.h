...
const char* ssid     = "Who Took My Flamingoz?! C";     // WiFi network you're trying to connect to
const char* password = "S3xyP@nts!";                    // Password for that WiFi network
...
const String File_Updater_Description   = "/ArduinoFiles/Async_Message_Board_Alex/Async_File_Uploader.php"; // This + root will go to the page that will check the update status
